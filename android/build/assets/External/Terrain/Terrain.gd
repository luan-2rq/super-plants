...
@export var quadrant_size: int = 300
@export var quadrant_grid_size: Vector2 = Vector2(4,10)
...
func carve(global_pos, carve_radius):
	var carve_polygon = Transform2D(0, global_pos - self.global_position) * (_make_circle(carve_radius))
